    ...
    <div className="min-h-[100vh] h-full w-full flex flex-col items-center gap-5 justify-around bg-[#f4f4f9] p-10">
      ...
      className="flex flex-col shadow-form-container w-[50%]  bg-white p-[2rem] rounded-lg text-[#333] gap-7">
        ...
        <div className="flex gap-2">
          <button
            type="submit"
            className="bg-blue-900 text-white hover:bg-blue-800 cursor-pointer text-center font-semibold text-2xl"
          >
          ...
          {isEdit && (
            <button
              ...
              className="bg-gray-400 text-white hover:bg-gray-500 cursor-pointer text-center font-semibold text-2xl"
            >
              Batal
            </button>
          )}
